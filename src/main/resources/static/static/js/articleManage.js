layui.use('table', function(){
    ...
    var tableIns = table.render({
        ...
        ,title: '资源数据表'
        ,cols: [[
            {field:'popularFeelingEvent', title:'舆情事件', width:300, fixed: 'left',templet: "#nameTpl"}
            ,{field:'email', title:'来源类别', width:100, templet: "#arcTypeTpl"}
            ,{field:'eventType', title:'类型', width:80, sort: true, templet: "#pointsTpl"}
            ,{field:'eventDate', title:'发布日期', width:177, sort: true}
            ,{field:'eventStatus', title:'处理状态', width:100, templet: "#stateTpl"}
